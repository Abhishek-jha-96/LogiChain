...
export type DistributorOrderByWithRelationInput = {
  Warehouse?: InputMaybe<WarehouseOrderByRelationAggregateInput>
...
export type DistributorWhereInput = {
  ...
  Warehouse?: InputMaybe<WarehouseListRelationFilter>
...
export type ManufacturerQuery = {
  ...
  manufacturer: {
    ...
    products: Array<{ __typename?: 'Product'; id: number; name: string }>
    warehouses: Array<{ __typename?: 'Warehouse'; id: number; name: string }>
  }
}
